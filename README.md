...
- See https://github.com/UltraCart/sdk_samples for samples for every method
...
Install-Package com.ultracart.admin.v2 -Version 4.1.174
```
...
*BulkApi* | [**BulkGenerateUploadUrl**](docs/BulkApi.md#bulkgenerateuploadurl) | **POST** /bulk/{object}/upload-url | Generate a presigned upload URL for a bulk payload
*BulkApi* | [**BulkGetJob**](docs/BulkApi.md#bulkgetjob) | **GET** /bulk/{object}/{job_id} | Retrieve a bulk job's status and counts
*BulkApi* | [**BulkGetJobRecords**](docs/BulkApi.md#bulkgetjobrecords) | **GET** /bulk/{object}/{job_id}/records | Paginate a bulk job's per-record results
*BulkApi* | [**BulkListJobs**](docs/BulkApi.md#bulklistjobs) | **GET** /bulk/{object} | List bulk jobs for the calling merchant
*BulkApi* | [**BulkSubmitJob**](docs/BulkApi.md#bulksubmitjob) | **POST** /bulk/{object} | Submit a bulk job
...
*ConversationApi* | [**DeleteAgentStatusConfig**](docs/ConversationApi.md#deleteagentstatusconfig) | **DELETE** /conversation/agent/status/config/{conversation_status_uuid} | Soft-deactivate a custom agent status
...
*ConversationApi* | [**DeletePbxClassOfService**](docs/ConversationApi.md#deletepbxclassofservice) | **DELETE** /conversation/pbx/class_of_service/{classOfServiceUuid} | Delete pbx class of service
...
*ConversationApi* | [**GetAgentStatusConfigs**](docs/ConversationApi.md#getagentstatusconfigs) | **GET** /conversation/agent/status/config | List custom agent statuses
*ConversationApi* | [**GetAgentStatusHeatmap**](docs/ConversationApi.md#getagentstatusheatmap) | **POST** /conversation/agent/status/heatmap | Agent x hour-of-day heatmap
*ConversationApi* | [**GetAgentStatusSummary**](docs/ConversationApi.md#getagentstatussummary) | **GET** /conversation/agent/status/rollup/summary | Dashboard summary for a date range
*ConversationApi* | [**GetAgentStatusTimeline**](docs/ConversationApi.md#getagentstatustimeline) | **GET** /conversation/agent/status/history/{agent_user_id}/timeline | Day timeline for a single agent
...
*ConversationApi* | [**GetConversationItemVariations**](docs/ConversationApi.md#getconversationitemvariations) | **GET** /conversation/items/{merchant_item_id}/variations | Retrieve an item with sparse variations populated
...
*ConversationApi* | [**GetPbxCall**](docs/ConversationApi.md#getpbxcall) | **GET** /conversation/pbx/call/{callUuid} | Get pbx call record
*ConversationApi* | [**GetPbxClassOfService**](docs/ConversationApi.md#getpbxclassofservice) | **GET** /conversation/pbx/class_of_service/{classOfServiceUuid} | Get pbx class of service
*ConversationApi* | [**GetPbxClassesOfService**](docs/ConversationApi.md#getpbxclassesofservice) | **GET** /conversation/pbx/class_of_service | Get pbx classes of service
*ConversationApi* | [**GetPbxCosAuditLogs**](docs/ConversationApi.md#getpbxcosauditlogs) | **GET** /conversation/pbx/class_of_service/audit_log | Get pbx class of service audit logs
*ConversationApi* | [**GetPbxDefaultTimezone**](docs/ConversationApi.md#getpbxdefaulttimezone) | **GET** /conversation/pbx/config/default-timezone | Get the merchant default timezone
...
*ConversationApi* | [**GetPbxPayConnectors**](docs/ConversationApi.md#getpbxpayconnectors) | **GET** /conversation/pbx/pay_connector | Get pbx pay connectors
...
*ConversationApi* | [**InsertAgentStatusConfig**](docs/ConversationApi.md#insertagentstatusconfig) | **POST** /conversation/agent/status/config | Create a custom agent status
...
*ConversationApi* | [**InsertPbxClassOfService**](docs/ConversationApi.md#insertpbxclassofservice) | **POST** /conversation/pbx/class_of_service | Insert pbx class of service
...
*ConversationApi* | [**SearchAgentStatusHistory**](docs/ConversationApi.md#searchagentstatushistory) | **POST** /conversation/agent/status/history/search | Search agent status history
*ConversationApi* | [**SearchAgentStatusRollups**](docs/ConversationApi.md#searchagentstatusrollups) | **POST** /conversation/agent/status/rollup/search | Search per-(agent, day) rollups
...
*ConversationApi* | [**UpdateAgentStatusConfig**](docs/ConversationApi.md#updateagentstatusconfig) | **PUT** /conversation/agent/status/config/{conversation_status_uuid} | Update a custom agent status
...
*ConversationEmbedApi* | [**EmbedOauthDeviceAuthorize**](docs/ConversationEmbedApi.md#embedoauthdeviceauthorize) | **POST** /conversation_embed/oauth/device/authorize | Initiate a device authorization flow for an embed widget.
*ConversationEmbedApi* | [**EmbedOauthRevoke**](docs/ConversationEmbedApi.md#embedoauthrevoke) | **POST** /conversation_embed/oauth/device/revoke | Revoke an embed widget access or refresh token.
*ConversationEmbedApi* | [**EmbedOauthToken**](docs/ConversationEmbedApi.md#embedoauthtoken) | **POST** /conversation_embed/oauth/device/token | Exchange a device_code or refresh_token for an access token (embed widget).
*ConversationEmbedApi* | [**GetEmbedPbxAuth**](docs/ConversationEmbedApi.md#getembedpbxauth) | **PUT** /conversation_embed/pbx-auth | Get PBX authorization for the embedded softphone widget.
...
*CustomerApi* | [**UpdateCustomerEmailSuppression**](docs/CustomerApi.md#updatecustomeremailsuppression) | **POST** /customer/customers/{customer_profile_oid}/email_suppression | Clear email suppression for a customer
...
*SfvbApi* | [**GetSfvbUpsellOffer**](docs/SfvbApi.md#getsfvbupselloffer) | **GET** /sfvb/storefronts/{storefront_oid}/upsell_offers/{upsell_offer_oid} | Get an upsell offer
...
## Documentation for Models
 ...
 - [Model.AdjustLoyaltyPointsRequest](docs/AdjustLoyaltyPointsRequest.md)
 - [Model.AdjustLoyaltyPointsResponse](docs/AdjustLoyaltyPointsResponse.md)
 - [Model.Affiliate](docs/Affiliate.md)
 - [Model.AffiliateAttribute](docs/AffiliateAttribute.md)
 ...
 - [Model.AffiliateMarketingStrategy](docs/AffiliateMarketingStrategy.md)
 - [Model.AffiliateQuery](docs/AffiliateQuery.md)
 - [Model.AffiliateResponse](docs/AffiliateResponse.md)
 - [Model.AffiliateTierRelationship](docs/AffiliateTierRelationship.md)
 - [Model.AffiliatesResponse](docs/AffiliatesResponse.md)
 - [Model.AgentSummary](docs/AgentSummary.md)
 - [Model.AnrokConfig](docs/AnrokConfig.md)
 ...
 - [Model.AutoOrderAddonItemsUpdateRequest](docs/AutoOrderAddonItemsUpdateRequest.md)
 - [Model.AutoOrderCancelReason](docs/AutoOrderCancelReason.md)
 - [Model.AutoOrderCancelReasonsResponse](docs/AutoOrderCancelReasonsResponse.md)
 - [Model.AutoOrderConsolidate](docs/AutoOrderConsolidate.md)
 - [Model.AutoOrderEmail](docs/AutoOrderEmail.md)
 - [Model.AutoOrderEmailsResponse](docs/AutoOrderEmailsResponse.md)
 - [Model.AutoOrderItem](docs/AutoOrderItem.md)
 - [Model.AutoOrderItemCancelRequest](docs/AutoOrderItemCancelRequest.md)
 ...
 - [Model.AutoOrderPaymentUpdateRequest](docs/AutoOrderPaymentUpdateRequest.md)
 - [Model.AutoOrderPropertiesUpdateRequest](docs/AutoOrderPropertiesUpdateRequest.md)
 - [Model.AutoOrderProperty](docs/AutoOrderProperty.md)
 - [Model.AutoOrderQuery](docs/AutoOrderQuery.md)
 - [Model.AutoOrderQueryBatch](docs/AutoOrderQueryBatch.md)
 - [Model.AutoOrderRebillResponse](docs/AutoOrderRebillResponse.md)
 ...
 - [Model.BulkJob](docs/BulkJob.md)
 - [Model.BulkJobRequest](docs/BulkJobRequest.md)
 - [Model.BulkJobResponse](docs/BulkJobResponse.md)
 - [Model.BulkJobsResponse](docs/BulkJobsResponse.md)
 - [Model.BulkRecord](docs/BulkRecord.md)
 - [Model.BulkRecordsResponse](docs/BulkRecordsResponse.md)
 - [Model.BulkUploadUrlResponse](docs/BulkUploadUrlResponse.md)
 ...
 - [Model.ConversationAgentAuthMerchant](docs/ConversationAgentAuthMerchant.md)
 - [Model.ConversationAgentAuthResponse](docs/ConversationAgentAuthResponse.md)
 - [Model.ConversationAgentCallEvent](docs/ConversationAgentCallEvent.md)
 - [Model.ConversationAgentChatEvent](docs/ConversationAgentChatEvent.md)
 ...
 - [Model.ConversationAgentStatusConfig](docs/ConversationAgentStatusConfig.md)
 - [Model.ConversationAgentStatusConfigResponse](docs/ConversationAgentStatusConfigResponse.md)
 - [Model.ConversationAgentStatusConfigsResponse](docs/ConversationAgentStatusConfigsResponse.md)
 - [Model.ConversationAgentStatusEvent](docs/ConversationAgentStatusEvent.md)
 - [Model.ConversationAgentStatusHeatmapRequest](docs/ConversationAgentStatusHeatmapRequest.md)
 - [Model.ConversationAgentStatusHeatmapResponse](docs/ConversationAgentStatusHeatmapResponse.md)
 - [Model.ConversationAgentStatusHistorySearchRequest](docs/ConversationAgentStatusHistorySearchRequest.md)
 - [Model.ConversationAgentStatusHistorySearchResponse](docs/ConversationAgentStatusHistorySearchResponse.md)
 - [Model.ConversationAgentStatusRollup](docs/ConversationAgentStatusRollup.md)
 - [Model.ConversationAgentStatusRollupSearchRequest](docs/ConversationAgentStatusRollupSearchRequest.md)
 - [Model.ConversationAgentStatusRollupSearchResponse](docs/ConversationAgentStatusRollupSearchResponse.md)
 - [Model.ConversationAgentStatusSummaryResponse](docs/ConversationAgentStatusSummaryResponse.md)
 - [Model.ConversationAgentStatusTimelineResponse](docs/ConversationAgentStatusTimelineResponse.md)
 - [Model.ConversationAgentTestSessionJoinRequest](docs/ConversationAgentTestSessionJoinRequest.md)
 - [Model.ConversationAgentTestSessionRequest](docs/ConversationAgentTestSessionRequest.md)
 - [Model.ConversationAgentTestSessionResponse](docs/ConversationAgentTestSessionResponse.md)
 ...
 - [Model.ConversationCustomerAuth](docs/ConversationCustomerAuth.md)
 ...
 - [Model.ConversationEmbedPbxAuthResponse](docs/ConversationEmbedPbxAuthResponse.md)
 ...
 - [Model.ConversationPbxCall](docs/ConversationPbxCall.md)
 - [Model.ConversationPbxCallAgent](docs/ConversationPbxCallAgent.md)
 - [Model.ConversationPbxCallAiCost](docs/ConversationPbxCallAiCost.md)
 - [Model.ConversationPbxCallAiEngagement](docs/ConversationPbxCallAiEngagement.md)
 - [Model.ConversationPbxCallAiSummary](docs/ConversationPbxCallAiSummary.md)
 - [Model.ConversationPbxCallAiToolCall](docs/ConversationPbxCallAiToolCall.md)
 - [Model.ConversationPbxCallAiWhisper](docs/ConversationPbxCallAiWhisper.md)
 - [Model.ConversationPbxCallCaller](docs/ConversationPbxCallCaller.md)
 - [Model.ConversationPbxCallFinancial](docs/ConversationPbxCallFinancial.md)
 - [Model.ConversationPbxCallHold](docs/ConversationPbxCallHold.md)
 - [Model.ConversationPbxCallQueue](docs/ConversationPbxCallQueue.md)
 - [Model.ConversationPbxCallRecording](docs/ConversationPbxCallRecording.md)
 - [Model.ConversationPbxCallResponse](docs/ConversationPbxCallResponse.md)
 - [Model.ConversationPbxCallRouting](docs/ConversationPbxCallRouting.md)
 - [Model.ConversationPbxCallSearchRequest](docs/ConversationPbxCallSearchRequest.md)
 - [Model.ConversationPbxCallSearchResponse](docs/ConversationPbxCallSearchResponse.md)
 - [Model.ConversationPbxCallTimeline](docs/ConversationPbxCallTimeline.md)
 - [Model.ConversationPbxCallTranscript](docs/ConversationPbxCallTranscript.md)
 - [Model.ConversationPbxCallTranscriptSegment](docs/ConversationPbxCallTranscriptSegment.md)
 - [Model.ConversationPbxCallTransfer](docs/ConversationPbxCallTransfer.md)
 - [Model.ConversationPbxCallUpdateRequest](docs/ConversationPbxCallUpdateRequest.md)
 - [Model.ConversationPbxClassOfService](docs/ConversationPbxClassOfService.md)
 - [Model.ConversationPbxClassOfServiceResponse](docs/ConversationPbxClassOfServiceResponse.md)
 - [Model.ConversationPbxClassOfServicesResponse](docs/ConversationPbxClassOfServicesResponse.md)
 - [Model.ConversationPbxCosAuditLog](docs/ConversationPbxCosAuditLog.md)
 - [Model.ConversationPbxCosAuditLogsResponse](docs/ConversationPbxCosAuditLogsResponse.md)
 ...
 - [Model.ConversationPbxDefaultTimezoneResponse](docs/ConversationPbxDefaultTimezoneResponse.md)
 - [Model.ConversationPbxDefaultTimezoneUpdateRequest](docs/ConversationPbxDefaultTimezoneUpdateRequest.md)
 ...
 - [Model.ConversationPbxPayConnector](docs/ConversationPbxPayConnector.md)
 - [Model.ConversationPbxPayConnectorsResponse](docs/ConversationPbxPayConnectorsResponse.md)
 ...
 - [Model.ConversationPbxVoicemailCapabilitiesResponse](docs/ConversationPbxVoicemailCapabilitiesResponse.md)
 ...
 - [Model.ConversationVirtualAgentCapabilityCustomCollection](docs/ConversationVirtualAgentCapabilityCustomCollection.md)
 ...
 - [Model.CouponAmountOffItemsAndFreeShipping](docs/CouponAmountOffItemsAndFreeShipping.md)
 ...
 - [Model.CouponPercentOffItemsWithMinimumItemAmount](docs/CouponPercentOffItemsWithMinimumItemAmount.md)
 ...
 - [Model.CustomerEmailSuppressionRequest](docs/CustomerEmailSuppressionRequest.md)
 - [Model.CustomerEmailSuppressionResponse](docs/CustomerEmailSuppressionResponse.md)
 - [Model.CustomerEmailSuppressionResult](docs/CustomerEmailSuppressionResult.md)
 ...
 - [Model.CustomerLoyaltyResponse](docs/CustomerLoyaltyResponse.md)
 ...
 - [Model.EmailCommseqEmailReviewStatus](docs/EmailCommseqEmailReviewStatus.md)
 - [Model.EmailCommseqEmailReviewStatusResponse](docs/EmailCommseqEmailReviewStatusResponse.md)
 - [Model.EmailCommseqEmailReviewStatusesRequest](docs/EmailCommseqEmailReviewStatusesRequest.md)
 - [Model.EmailCommseqEmailReviewStatusesResponse](docs/EmailCommseqEmailReviewStatusesResponse.md)
 ...
 - [Model.EmailCommseqEnrollmentRequest](docs/EmailCommseqEnrollmentRequest.md)
 - [Model.EmailCommseqEnrollmentResponse](docs/EmailCommseqEnrollmentResponse.md)
 ...
 - [Model.EmailCustomerLookupResponse](docs/EmailCustomerLookupResponse.md)
 ...
 - [Model.EmailDispatchLog](docs/EmailDispatchLog.md)
 - [Model.EmailDispatchLogDetail](docs/EmailDispatchLogDetail.md)
 - [Model.EmailDispatchLogDetailResponse](docs/EmailDispatchLogDetailResponse.md)
 - [Model.EmailDispatchLogsResponse](docs/EmailDispatchLogsResponse.md)
 ...
 - [Model.EmailSuppressionSurfaces](docs/EmailSuppressionSurfaces.md)
 ...
 - [Model.FraudDeclineEmailRequest](docs/FraudDeclineEmailRequest.md)
 - [Model.FraudLookupAffiliate](docs/FraudLookupAffiliate.md)
 - [Model.FraudLookupGateway](docs/FraudLookupGateway.md)
 - [Model.FraudLookupTheme](docs/FraudLookupTheme.md)
 - [Model.FraudLookupValues](docs/FraudLookupValues.md)
 - [Model.FraudLookupValuesResponse](docs/FraudLookupValuesResponse.md)
 - [Model.FraudRuleFromOrderRequest](docs/FraudRuleFromOrderRequest.md)
 - [Model.FraudRuleInsertRequest](docs/FraudRuleInsertRequest.md)
 - [Model.FraudRuleItemFilter](docs/FraudRuleItemFilter.md)
 - [Model.FraudRulePublic](docs/FraudRulePublic.md)
 - [Model.FraudRuleResponse](docs/FraudRuleResponse.md)
 - [Model.FraudRuleRotatingTransactionGatewayFilter](docs/FraudRuleRotatingTransactionGatewayFilter.md)
 - [Model.FraudRuleSearchRequest](docs/FraudRuleSearchRequest.md)
 - [Model.FraudRuleStorefrontFilter](docs/FraudRuleStorefrontFilter.md)
 - [Model.FraudRulesResponse](docs/FraudRulesResponse.md)
 ...
 - [Model.ItemGatedCode](docs/ItemGatedCode.md)
 - [Model.ItemGatedCodeResponse](docs/ItemGatedCodeResponse.md)
 - [Model.ItemGatedCodesRequest](docs/ItemGatedCodesRequest.md)
 - [Model.ItemGatedCodesResponse](docs/ItemGatedCodesResponse.md)
 - [Model.ItemGenerateGatedCodesRequest](docs/ItemGenerateGatedCodesRequest.md)
 ...
 - [Model.OauthDeviceAuthorizationResponse](docs/OauthDeviceAuthorizationResponse.md)
 ...
 - [Model.OrderAddItemsAndReleaseRequest](docs/OrderAddItemsAndReleaseRequest.md)
 ...
 - [Model.OrderCustomerActivityResponse](docs/OrderCustomerActivityResponse.md)
 ...
 - [Model.OrderEmail](docs/OrderEmail.md)
 - [Model.OrderEmailsResponse](docs/OrderEmailsResponse.md)
 ...
 - [Model.OrderPageView](docs/OrderPageView.md)
 - [Model.OrderPageViewHistoryResponse](docs/OrderPageViewHistoryResponse.md)
 - [Model.OrderPageViewMetaData](docs/OrderPageViewMetaData.md)
 - [Model.OrderPageViewParam](docs/OrderPageViewParam.md)
 ...
 - [Model.OrderQueryPaymentTransactionFilter](docs/OrderQueryPaymentTransactionFilter.md)
 ...
 - [Model.OrderUpsellCartRequest](docs/OrderUpsellCartRequest.md)
 ...
 - [Model.QuickBooksOnlineCustomer](docs/QuickBooksOnlineCustomer.md)
 - [Model.QuickBooksOnlineCustomersResponse](docs/QuickBooksOnlineCustomersResponse.md)
 ...
 - [Model.SfvbBlogPost](docs/SfvbBlogPost.md)
 - [Model.SfvbBlogPostsResponse](docs/SfvbBlogPostsResponse.md)
 - [Model.SfvbCompileRequest](docs/SfvbCompileRequest.md)
 - [Model.SfvbCompileResponse](docs/SfvbCompileResponse.md)
 - [Model.SfvbContainerResponse](docs/SfvbContainerResponse.md)
 - [Model.SfvbContainerRevertRequest](docs/SfvbContainerRevertRequest.md)
 - [Model.SfvbContainerVersion](docs/SfvbContainerVersion.md)
 - [Model.SfvbContainerVersionsResponse](docs/SfvbContainerVersionsResponse.md)
 - [Model.SfvbContainerWriteRequest](docs/SfvbContainerWriteRequest.md)
 - [Model.SfvbElement](docs/SfvbElement.md)
 - [Model.SfvbElementSchemaResponse](docs/SfvbElementSchemaResponse.md)
 - [Model.SfvbElementsResponse](docs/SfvbElementsResponse.md)
 - [Model.SfvbErrorDetail](docs/SfvbErrorDetail.md)
 - [Model.SfvbExperiment](docs/SfvbExperiment.md)
 - [Model.SfvbExperimentEndRequest](docs/SfvbExperimentEndRequest.md)
 - [Model.SfvbExperimentObjective](docs/SfvbExperimentObjective.md)
 - [Model.SfvbExperimentObjectivesResponse](docs/SfvbExperimentObjectivesResponse.md)
 - [Model.SfvbExperimentStartRequest](docs/SfvbExperimentStartRequest.md)
 - [Model.SfvbExperimentStartVariation](docs/SfvbExperimentStartVariation.md)
 - [Model.SfvbExperimentVariationUpdateRequest](docs/SfvbExperimentVariationUpdateRequest.md)
 - [Model.SfvbExperimentsResponse](docs/SfvbExperimentsResponse.md)
 - [Model.SfvbFileContentResponse](docs/SfvbFileContentResponse.md)
 - [Model.SfvbFileEntry](docs/SfvbFileEntry.md)
 - [Model.SfvbFileRevertRequest](docs/SfvbFileRevertRequest.md)
 - [Model.SfvbFileSearchRequest](docs/SfvbFileSearchRequest.md)
 - [Model.SfvbFileSearchResponse](docs/SfvbFileSearchResponse.md)
 - [Model.SfvbFileUploadRequest](docs/SfvbFileUploadRequest.md)
 - [Model.SfvbFileUploadUrlResponse](docs/SfvbFileUploadUrlResponse.md)
 - [Model.SfvbFileVersion](docs/SfvbFileVersion.md)
 - [Model.SfvbFileVersionsResponse](docs/SfvbFileVersionsResponse.md)
 - [Model.SfvbFileWriteRequest](docs/SfvbFileWriteRequest.md)
 - [Model.SfvbFileWriteResponse](docs/SfvbFileWriteResponse.md)
 - [Model.SfvbFilesResponse](docs/SfvbFilesResponse.md)
 - [Model.SfvbItemAttribute](docs/SfvbItemAttribute.md)
 - [Model.SfvbItemAttributeUpdate](docs/SfvbItemAttributeUpdate.md)
 - [Model.SfvbItemAttributeUpdateRequest](docs/SfvbItemAttributeUpdateRequest.md)
 - [Model.SfvbItemContainer](docs/SfvbItemContainer.md)
 - [Model.SfvbItemContainersResponse](docs/SfvbItemContainersResponse.md)
 - [Model.SfvbItemContentRequest](docs/SfvbItemContentRequest.md)
 - [Model.SfvbItemMultimedia](docs/SfvbItemMultimedia.md)
 - [Model.SfvbItemMultimediaRequest](docs/SfvbItemMultimediaRequest.md)
 - [Model.SfvbItemResponse](docs/SfvbItemResponse.md)
 - [Model.SfvbItemSeo](docs/SfvbItemSeo.md)
 - [Model.SfvbItemSeoRequest](docs/SfvbItemSeoRequest.md)
 - [Model.SfvbLibraryEntry](docs/SfvbLibraryEntry.md)
 - [Model.SfvbLibraryFacet](docs/SfvbLibraryFacet.md)
 - [Model.SfvbLibraryResponse](docs/SfvbLibraryResponse.md)
 - [Model.SfvbMenu](docs/SfvbMenu.md)
 - [Model.SfvbMenuItem](docs/SfvbMenuItem.md)
 - [Model.SfvbMenuWriteRequest](docs/SfvbMenuWriteRequest.md)
 - [Model.SfvbMenusResponse](docs/SfvbMenusResponse.md)
 - [Model.SfvbPageAttribute](docs/SfvbPageAttribute.md)
 - [Model.SfvbPageAttributeUpdate](docs/SfvbPageAttributeUpdate.md)
 - [Model.SfvbPageAttributeUpdateRequest](docs/SfvbPageAttributeUpdateRequest.md)
 - [Model.SfvbPageBlogPostSelector](docs/SfvbPageBlogPostSelector.md)
 - [Model.SfvbPageBlogPostsRequest](docs/SfvbPageBlogPostsRequest.md)
 - [Model.SfvbPageBlogPostsResponse](docs/SfvbPageBlogPostsResponse.md)
 - [Model.SfvbPageCreateRequest](docs/SfvbPageCreateRequest.md)
 - [Model.SfvbPageDuplicateRequest](docs/SfvbPageDuplicateRequest.md)
 - [Model.SfvbPageItem](docs/SfvbPageItem.md)
 - [Model.SfvbPageItemSelector](docs/SfvbPageItemSelector.md)
 - [Model.SfvbPageItemsAddRequest](docs/SfvbPageItemsAddRequest.md)
 - [Model.SfvbPageItemsRemoveRequest](docs/SfvbPageItemsRemoveRequest.md)
 - [Model.SfvbPageItemsResponse](docs/SfvbPageItemsResponse.md)
 - [Model.SfvbPageListResponse](docs/SfvbPageListResponse.md)
 - [Model.SfvbPageMultimedia](docs/SfvbPageMultimedia.md)
 - [Model.SfvbPageMultimediaRequest](docs/SfvbPageMultimediaRequest.md)
 - [Model.SfvbPageResponse](docs/SfvbPageResponse.md)
 - [Model.SfvbPageSelectors](docs/SfvbPageSelectors.md)
 - [Model.SfvbPageSettingsRequest](docs/SfvbPageSettingsRequest.md)
 - [Model.SfvbPageSummary](docs/SfvbPageSummary.md)
 - [Model.SfvbPreviewAccessRequest](docs/SfvbPreviewAccessRequest.md)
 - [Model.SfvbPreviewAccessResponse](docs/SfvbPreviewAccessResponse.md)
 - [Model.SfvbPreviewSessionRequest](docs/SfvbPreviewSessionRequest.md)
 - [Model.SfvbPreviewSessionResponse](docs/SfvbPreviewSessionResponse.md)
 - [Model.SfvbPreviewUrlResponse](docs/SfvbPreviewUrlResponse.md)
 - [Model.SfvbRenderRequest](docs/SfvbRenderRequest.md)
 - [Model.SfvbRenderResponse](docs/SfvbRenderResponse.md)
 - [Model.SfvbSiteAttribute](docs/SfvbSiteAttribute.md)
 - [Model.SfvbSiteAttributeUpdate](docs/SfvbSiteAttributeUpdate.md)
 - [Model.SfvbSiteAttributeUpdateRequest](docs/SfvbSiteAttributeUpdateRequest.md)
 - [Model.SfvbSiteAttributesResponse](docs/SfvbSiteAttributesResponse.md)
 - [Model.SfvbStorefront](docs/SfvbStorefront.md)
 - [Model.SfvbStorefrontsResponse](docs/SfvbStorefrontsResponse.md)
 - [Model.SfvbTemplate](docs/SfvbTemplate.md)
 - [Model.SfvbTemplateResolveCandidate](docs/SfvbTemplateResolveCandidate.md)
 - [Model.SfvbTemplateResolvePath](docs/SfvbTemplateResolvePath.md)
 - [Model.SfvbTemplateResolveResponse](docs/SfvbTemplateResolveResponse.md)
 - [Model.SfvbTemplatesResponse](docs/SfvbTemplatesResponse.md)
 - [Model.SfvbTheme](docs/SfvbTheme.md)
 - [Model.SfvbThemeAttribute](docs/SfvbThemeAttribute.md)
 - [Model.SfvbThemeAttributeUpdate](docs/SfvbThemeAttributeUpdate.md)
 - [Model.SfvbThemeAttributeUpdateRequest](docs/SfvbThemeAttributeUpdateRequest.md)
 - [Model.SfvbThemeAttributesResponse](docs/SfvbThemeAttributesResponse.md)
 - [Model.SfvbThemeDuplicateRequest](docs/SfvbThemeDuplicateRequest.md)
 - [Model.SfvbThemeFont](docs/SfvbThemeFont.md)
 - [Model.SfvbThemeFontFamily](docs/SfvbThemeFontFamily.md)
 - [Model.SfvbThemeJobResponse](docs/SfvbThemeJobResponse.md)
 - [Model.SfvbThemesResponse](docs/SfvbThemesResponse.md)
 - [Model.SfvbUpsellItemLogic](docs/SfvbUpsellItemLogic.md)
 - [Model.SfvbUpsellItemLogicItem](docs/SfvbUpsellItemLogicItem.md)
 - [Model.SfvbUpsellOffer](docs/SfvbUpsellOffer.md)
 - [Model.SfvbUpsellOffersResponse](docs/SfvbUpsellOffersResponse.md)
 - [Model.SfvbUpsellPath](docs/SfvbUpsellPath.md)
 - [Model.SfvbUpsellPathDuplicateRequest](docs/SfvbUpsellPathDuplicateRequest.md)
 - [Model.SfvbUpsellPathMoveRequest](docs/SfvbUpsellPathMoveRequest.md)
 - [Model.SfvbUpsellPathsResponse](docs/SfvbUpsellPathsResponse.md)
 - [Model.SfvbUpsellStats](docs/SfvbUpsellStats.md)
 - [Model.SfvbUpsellStep](docs/SfvbUpsellStep.md)
 - [Model.SfvbUpsellStepOffer](docs/SfvbUpsellStepOffer.md)
 - [Model.SfvbUpsellTowerData](docs/SfvbUpsellTowerData.md)
 - [Model.SfvbUpsellVariation](docs/SfvbUpsellVariation.md)
 - [Model.SfvbValidateRequest](docs/SfvbValidateRequest.md)
 - [Model.SfvbValidationResponse](docs/SfvbValidationResponse.md)
 - [Model.SfvbVelocityValidateRequest](docs/SfvbVelocityValidateRequest.md)
 - [Model.SfvbVersionResponse](docs/SfvbVersionResponse.md)
 - [Model.SfvbWhoamiResponse](docs/SfvbWhoamiResponse.md)
 - [Model.SfvbWidgetIdsResponse](docs/SfvbWidgetIdsResponse.md)
 ...
 - [Model.TaxProviderAnrok](docs/TaxProviderAnrok.md)
 ...
 - [Model.TimelineSummary](docs/TimelineSummary.md)
 ...
 - [Model.WebhookEventCategoriesResponse](docs/WebhookEventCategoriesResponse.md)
 ...
 - [Model.ZohoDeskTicketSummary](docs/ZohoDeskTicketSummary.md)
