...
## Documentation for Models
 ...
 - [Model.DelayAutoOrdersResponse](docs/DelayAutoOrdersResponse.md)
 ...
 - [Model.PaymentsConfiguration](docs/PaymentsConfiguration.md)
 - [Model.PaymentsConfigurationAffirm](docs/PaymentsConfigurationAffirm.md)
 - [Model.PaymentsConfigurationAmazon](docs/PaymentsConfigurationAmazon.md)
 - [Model.PaymentsConfigurationCOD](docs/PaymentsConfigurationCOD.md)
 - [Model.PaymentsConfigurationCash](docs/PaymentsConfigurationCash.md)
 - [Model.PaymentsConfigurationCheck](docs/PaymentsConfigurationCheck.md)
 - [Model.PaymentsConfigurationCreditCard](docs/PaymentsConfigurationCreditCard.md)
 - [Model.PaymentsConfigurationCreditCardType](docs/PaymentsConfigurationCreditCardType.md)
 - [Model.PaymentsConfigurationEcheck](docs/PaymentsConfigurationEcheck.md)
 - [Model.PaymentsConfigurationInsurance](docs/PaymentsConfigurationInsurance.md)
 - [Model.PaymentsConfigurationLoanHero](docs/PaymentsConfigurationLoanHero.md)
 - [Model.PaymentsConfigurationMoneyOrder](docs/PaymentsConfigurationMoneyOrder.md)
 - [Model.PaymentsConfigurationPayPal](docs/PaymentsConfigurationPayPal.md)
 - [Model.PaymentsConfigurationPurchaseOrder](docs/PaymentsConfigurationPurchaseOrder.md)
 - [Model.PaymentsConfigurationQuoteRequest](docs/PaymentsConfigurationQuoteRequest.md)
 - [Model.PaymentsConfigurationResponse](docs/PaymentsConfigurationResponse.md)
 - [Model.PaymentsConfigurationRestrictions](docs/PaymentsConfigurationRestrictions.md)
 - [Model.PaymentsConfigurationRestrictionsTheme](docs/PaymentsConfigurationRestrictionsTheme.md)
 - [Model.PaymentsConfigurationSezzle](docs/PaymentsConfigurationSezzle.md)
 - [Model.PaymentsConfigurationTestMethod](docs/PaymentsConfigurationTestMethod.md)
 - [Model.PaymentsConfigurationWePay](docs/PaymentsConfigurationWePay.md)
 - [Model.PaymentsConfigurationWireTransfer](docs/PaymentsConfigurationWireTransfer.md)
 - [Model.PaymentsThemeTransactionType](docs/PaymentsThemeTransactionType.md)
 - [Model.PaymentsWepayEnroll](docs/PaymentsWepayEnroll.md)
 ...
 - [Model.RotatingTransactionGateway](docs/RotatingTransactionGateway.md)
 - [Model.RotatingTransactionGatewayResponse](docs/RotatingTransactionGatewayResponse.md)
 - [Model.RotatingTransactionGatewaysResponse](docs/RotatingTransactionGatewaysResponse.md)
 - [Model.RtgCurrency](docs/RtgCurrency.md)
 - [Model.RtgDayOfMonthRestriction](docs/RtgDayOfMonthRestriction.md)
 - [Model.RtgDayOfWeekRestriction](docs/RtgDayOfWeekRestriction.md)
 - [Model.RtgSummaryGateway](docs/RtgSummaryGateway.md)
 - [Model.RtgSummaryResponse](docs/RtgSummaryResponse.md)
 - [Model.RtgThemeRestriction](docs/RtgThemeRestriction.md)
 ...
 - [Model.StripeConnectResponse](docs/StripeConnectResponse.md)
 ...
 - [Model.TransactionGateway](docs/TransactionGateway.md)
 - [Model.TransactionGatewaysRequest](docs/TransactionGatewaysRequest.md)
 - [Model.TransactionGatewaysResponse](docs/TransactionGatewaysResponse.md)
