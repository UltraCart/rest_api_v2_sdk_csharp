...
------------- | ------------- | ------------- | -------------
 **affiliateOid** | **int**| The affiliate oid to delete. | 
...
> AffiliateResponse GetAffiliate (int affiliateOid, string expand = null)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **affiliateOid** | **int**| The affiliate oid to retrieve. | 
...
> AffiliatesResponse GetAffiliatesByQuery (AffiliateQuery affiliateQuery, int? limit = null, int? offset = null, string sort = null)
...
> AffiliateResponse UpdateAffiliate (int affiliateOid, Affiliate affiliate, string expand = null)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **affiliateOid** | **int**| The affiliate oid to update. | 
