...
namespace Example
{
    public class CustomerCustomersCustomerProfileOidGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerCustomersCustomerProfileOidGet: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class CustomerCustomersCustomerProfileOidPutExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerCustomersCustomerProfileOidPut: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class CustomerCustomersGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerCustomersGet: " + e.Message );
            }
        }
    }
}
