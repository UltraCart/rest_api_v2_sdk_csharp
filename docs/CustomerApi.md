...
> QuickBooksOnlineCustomersResponse GetQuickBooksOnlineCustomers (string q = null)
...
> CustomerEmailSuppressionResponse UpdateCustomerEmailSuppression (int customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges)
