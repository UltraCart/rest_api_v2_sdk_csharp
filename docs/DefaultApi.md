# com.ultracart.admin.v2.Api.DefaultApi

All URIs are relative to *https://secure.ultracart.com/rest/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**DeleteCoupon**](DefaultApi.md#deletecoupon) | **DELETE** /coupon/coupons/{coupon_oid} | Delete a coupon
[**GetCoupon**](DefaultApi.md#getcoupon) | **GET** /coupon/coupons/{coupon_oid} | Retrieve a coupon
[**GetCoupons**](DefaultApi.md#getcoupons) | **GET** /coupon/coupons | Retrieve coupons
[**GetCouponsByQuery**](DefaultApi.md#getcouponsbyquery) | **GET** /coupon/coupons/query | Retrieve coupons by query
[**InsertCoupon**](DefaultApi.md#insertcoupon) | **POST** /coupon/coupons | Insert a coupon
[**UpdateCoupon**](DefaultApi.md#updatecoupon) | **PUT** /coupon/coupons/{coupon_oid} | Update a coupon
...
namespace Example
{
    public class DeleteCouponExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.DeleteCoupon: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetCouponExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.GetCoupon: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetCouponsExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.GetCoupons: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetCouponsByQueryExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.GetCouponsByQuery: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class InsertCouponExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.InsertCoupon: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class UpdateCouponExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.UpdateCoupon: " + e.Message );
            }
        }
    }
}
