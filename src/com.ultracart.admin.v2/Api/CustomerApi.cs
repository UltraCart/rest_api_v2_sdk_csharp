...
namespace com.ultracart.admin.v2.Api
{
    ...
    public interface ICustomerApi : IApiAccessor
    {
        ...
        /// <param name="expand">The object expansion to perform on the result.  See documentation for examples (optional)</param>
        /// <returns>CustomersResponse</returns>
        CustomersResponse SearchCustomers (string searchString = default(string), string signupDtsStart = default(string), string signupDtsEnd = default(string), int? limit = default(int?), int? offset = default(int?), string since = default(string), string sort = default(string), string expand = default(string));
        ...
        /// <param name="expand">The object expansion to perform on the result.  See documentation for examples (optional)</param>
        /// <returns>ApiResponse of CustomersResponse</returns>
        ApiResponse<CustomersResponse> SearchCustomersWithHttpInfo (string searchString = default(string), string signupDtsStart = default(string), string signupDtsEnd = default(string), int? limit = default(int?), int? offset = default(int?), string since = default(string), string sort = default(string), string expand = default(string));
        /// <summary>
        /// Update a customer
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="com.ultracart.admin.v2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="customerProfileOid">The customer profile oid</param>
        /// <param name="suppressionChanges">Suppression changes</param>
        /// <returns>CustomerEmailSuppressionResponse</returns>
        ...
        /// <param name="customerProfileOid">The customer profile oid</param>
        /// <param name="suppressionChanges">Suppression changes</param>
        /// <returns>ApiResponse of CustomerEmailSuppressionResponse</returns>
        ApiResponse<CustomerEmailSuppressionResponse> UpdateCustomerEmailSuppressionWithHttpInfo (int customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges);
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CustomersResponse</returns>
        System.Threading.Tasks.Task<CustomersResponse> SearchCustomersAsync (string searchString = default(string), string signupDtsStart = default(string), string signupDtsEnd = default(string), int? limit = default(int?), int? offset = default(int?), string since = default(string), string sort = default(string), string expand = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CustomersResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<CustomersResponse>> SearchCustomersWithHttpInfoAsync (string searchString = default(string), string signupDtsStart = default(string), string signupDtsEnd = default(string), int? limit = default(int?), int? offset = default(int?), string since = default(string), string sort = default(string), string expand = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update a customer
        /// </summary>
        /// <remarks>
        ...
        /// <param name="suppressionChanges">Suppression changes</param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CustomerEmailSuppressionResponse</returns>
        System.Threading.Tasks.Task<CustomerEmailSuppressionResponse> UpdateCustomerEmailSuppressionAsync (int customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="suppressionChanges">Suppression changes</param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CustomerEmailSuppressionResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<CustomerEmailSuppressionResponse>> UpdateCustomerEmailSuppressionWithHttpInfoAsync (int customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update a customer wishlist item
        /// </summary>
        /// <remarks>
    ...
    public partial class CustomerApi : ICustomerApi
    {
        ...
        /// <param name="expand">The object expansion to perform on the result.  See documentation for examples (optional)</param>
        /// <returns>CustomersResponse</returns>
        public CustomersResponse SearchCustomers (string searchString = default(string), string signupDtsStart = default(string), string signupDtsEnd = default(string), int? limit = default(int?), int? offset = default(int?), string since = default(string), string sort = default(string), string expand = default(string))
        {
        ...
        /// <param name="expand">The object expansion to perform on the result.  See documentation for examples (optional)</param>
        /// <returns>ApiResponse of CustomersResponse</returns>
        public ApiResponse<CustomersResponse> SearchCustomersWithHttpInfo (string searchString = default(string), string signupDtsStart = default(string), string signupDtsEnd = default(string), int? limit = default(int?), int? offset = default(int?), string since = default(string), string sort = default(string), string expand = default(string))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CustomersResponse</returns>
        public async System.Threading.Tasks.Task<CustomersResponse> SearchCustomersAsync (string searchString = default(string), string signupDtsStart = default(string), string signupDtsEnd = default(string), int? limit = default(int?), int? offset = default(int?), string since = default(string), string sort = default(string), string expand = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<CustomersResponse> localVarResponse = await SearchCustomersWithHttpInfoAsync(searchString, signupDtsStart, signupDtsEnd, limit, offset, since, sort, expand, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CustomersResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CustomersResponse>> SearchCustomersWithHttpInfoAsync (string searchString = default(string), string signupDtsStart = default(string), string signupDtsEnd = default(string), int? limit = default(int?), int? offset = default(int?), string since = default(string), string sort = default(string), string expand = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <summary>
        /// Clear email suppression for a customer Clears global unsubscribe, spam complaint and/or bounce suppression for a customer.  This method is clear-only and cannot set a suppression flag.  Clearing a suppression removes the send gate but does not subscribe the customer to any email list - - list membership survives a global unsubscribe untouched, so the customer's original lists become deliverable again with no further action.  Returns 200 with a warning if the flags were cleared but an upstream ESP suppression removal failed; the profile was still modified in that case. 
        /// </summary>
        /// <exception cref="com.ultracart.admin.v2.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="customerProfileOid">The customer profile oid</param>
        /// <param name="suppressionChanges">Suppression changes</param>
        /// <returns>CustomerEmailSuppressionResponse</returns>
        public CustomerEmailSuppressionResponse UpdateCustomerEmailSuppression (int customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges)
        {
             ApiResponse<CustomerEmailSuppressionResponse> localVarResponse = UpdateCustomerEmailSuppressionWithHttpInfo(customerProfileOid, suppressionChanges);
             return localVarResponse.Data;
        }
        ...
        /// <param name="suppressionChanges">Suppression changes</param>
        /// <returns>ApiResponse of CustomerEmailSuppressionResponse</returns>
        public ApiResponse<CustomerEmailSuppressionResponse> UpdateCustomerEmailSuppressionWithHttpInfo (int customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges)
        {
            // verify the required parameter 'customerProfileOid' is set
            if (customerProfileOid == null)
                throw new ApiException(400, "Missing required parameter 'customerProfileOid' when calling CustomerApi->UpdateCustomerEmailSuppression");
            // verify the required parameter 'suppressionChanges' is set
            if (suppressionChanges == null)
                throw new ApiException(400, "Missing required parameter 'suppressionChanges' when calling CustomerApi->UpdateCustomerEmailSuppression");

            var localVarPath = "/customer/customers/{customer_profile_oid}/email_suppression";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (customerProfileOid != null) localVarPathParams.Add("customer_profile_oid", this.Configuration.ApiClient.ParameterToString(customerProfileOid)); // path parameter
            if (suppressionChanges != null && suppressionChanges.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(suppressionChanges); // http body (model) parameter
            }
            else
            {
                localVarPostBody = suppressionChanges; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpdateCustomerEmailSuppression", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<CustomerEmailSuppressionResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (CustomerEmailSuppressionResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CustomerEmailSuppressionResponse)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CustomerEmailSuppressionResponse</returns>
        public async System.Threading.Tasks.Task<CustomerEmailSuppressionResponse> UpdateCustomerEmailSuppressionAsync (int customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<CustomerEmailSuppressionResponse> localVarResponse = await UpdateCustomerEmailSuppressionWithHttpInfoAsync(customerProfileOid, suppressionChanges, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CustomerEmailSuppressionResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CustomerEmailSuppressionResponse>> UpdateCustomerEmailSuppressionWithHttpInfoAsync (int customerProfileOid, CustomerEmailSuppressionRequest suppressionChanges, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'customerProfileOid' is set
            if (customerProfileOid == null)
                throw new ApiException(400, "Missing required parameter 'customerProfileOid' when calling CustomerApi->UpdateCustomerEmailSuppression");
