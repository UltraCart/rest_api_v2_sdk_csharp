...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdjustLoyaltyPointsResponse :  IEquatable<AdjustLoyaltyPointsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdjustLoyaltyPointsResponse" /> class.
        /// </summary>
        /// <param name="currentPoints">The current (vested) points balance after the adjustment was made.</param>
        /// <param name="error">error.</param>
        /// <param name="loyaltyPoints">The loyalty points adjustment that was written to the ledger.</param>
        /// <param name="metadata">metadata.</param>
        /// <param name="pendingPoints">The pending (unvested) points balance after the adjustment was made.</param>
        /// <param name="success">Indicates if API call was successful.</param>
        /// <param name="warning">warning.</param>
        public AdjustLoyaltyPointsResponse(int currentPoints = default(int), Error error = default(Error), int loyaltyPoints = default(int), ResponseMetadata metadata = default(ResponseMetadata), int pendingPoints = default(int), bool success = default(bool), Warning warning = default(Warning))
        {
        ...
        /// </summary>
        /// <value>The current (vested) points balance after the adjustment was made</value>
        ...
        /// </summary>
        /// <value>The loyalty points adjustment that was written to the ledger</value>
        ...
        /// </summary>
        /// <value>The pending (unvested) points balance after the adjustment was made</value>
        ...
        {
            return this.Equals(input as AdjustLoyaltyPointsResponse);
        }

        /// <summary>
        /// Returns true if AdjustLoyaltyPointsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdjustLoyaltyPointsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdjustLoyaltyPointsResponse input)
        {
            if (input == null)
                return false;
