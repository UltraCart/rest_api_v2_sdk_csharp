...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class AutoOrderResponse :  IEquatable<AutoOrderResponse>, IValidatableObject
    {
        ...
        public AutoOrderResponse(AutoOrder autoOrder = default(AutoOrder), Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), bool? success = default(bool?), Warning warning = default(Warning))
        {
