...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class BaseResponse :  IEquatable<BaseResponse>, IValidatableObject
    {
        ...
        public BaseResponse(Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), bool? success = default(bool?), Warning warning = default(Warning))
        {
            this.Error = error;
