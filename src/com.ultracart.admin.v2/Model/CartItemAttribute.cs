...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CartItemAttribute :  IEquatable<CartItemAttribute>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CartItemAttribute);
        }

        /// <summary>
        /// Returns true if CartItemAttribute instances are equal
        /// </summary>
        /// <param name="input">Instance of CartItemAttribute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CartItemAttribute input)
        {
            if (input == null)
                return false;
