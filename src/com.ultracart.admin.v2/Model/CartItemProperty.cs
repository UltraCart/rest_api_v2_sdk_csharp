...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CartItemProperty :  IEquatable<CartItemProperty>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CartItemProperty" /> class.
        /// </summary>
        ...
        public CartItemProperty(bool? display = default(bool?), string expirationDts = default(string), string name = default(string), string value = default(string))
        {
        ...
        {
            return this.Equals(input as CartItemProperty);
        }

        /// <summary>
        /// Returns true if CartItemProperty instances are equal
        /// </summary>
        /// <param name="input">Instance of CartItemProperty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CartItemProperty input)
        {
            if (input == null)
                return false;
