...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CartProperty :  IEquatable<CartProperty>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CartProperty" /> class.
        /// </summary>
        ...
        public CartProperty(bool display = default(bool), string expirationDts = default(string), string name = default(string), string value = default(string))
        {
        ...
        {
            return this.Equals(input as CartProperty);
        }

        /// <summary>
        /// Returns true if CartProperty instances are equal
        /// </summary>
        /// <param name="input">Instance of CartProperty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CartProperty input)
        {
            if (input == null)
                return false;
