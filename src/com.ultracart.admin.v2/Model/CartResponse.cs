...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CartResponse :  IEquatable<CartResponse>
    {
        /// <summary>
        ...
        public CartResponse(Cart Cart = null, List<string> Errors = null)
        {
            this.Cart = Cart;
            this.Errors = Errors;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CartResponse);
        }

        /// <summary>
        /// Returns true if CartResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CartResponse to be compared</param>
        /// <returns>Boolean</returns>
