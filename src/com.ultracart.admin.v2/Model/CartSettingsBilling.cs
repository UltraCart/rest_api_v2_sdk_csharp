...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CartSettingsBilling :  IEquatable<CartSettingsBilling>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CartSettingsBilling" /> class.
        /// </summary>
        /// <param name="Provinces">Provinces.</param>
        public CartSettingsBilling(List<CartSettingsProvince> Provinces = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CartSettingsBilling);
        }

        /// <summary>
        /// Returns true if CartSettingsBilling instances are equal
        /// </summary>
        /// <param name="other">Instance of CartSettingsBilling to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CartSettingsBilling other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
