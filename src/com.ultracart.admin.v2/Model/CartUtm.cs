...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CartUtm :  IEquatable<CartUtm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CartUtm" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CartUtm);
        }

        /// <summary>
        /// Returns true if CartUtm instances are equal
        /// </summary>
        /// <param name="input">Instance of CartUtm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CartUtm input)
        {
            if (input == null)
                return false;
