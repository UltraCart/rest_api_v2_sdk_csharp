...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ChannelPartnerOrder :  IEquatable<ChannelPartnerOrder>, IValidatableObject
    {
        ...
        /// <param name="arbitraryPricingTierNames">Names of pricing tiers to price this order against, without associating a customer profile.  An unknown tier name will fail the import.  An item that also supplies arbitrary_unit_cost keeps that cost and ignores the tier.  If a customer profile is attached to this order during checkout, these tiers are granted to that profile permanently..</param>
        ...
        /// <param name="creationDts">Date/time the original order was placed on the channel partner&#39;s system, in ISO8601 format. Only honored when store_completed is true (historical order imports). Rejected on live orders..</param>
        ...
        /// <param name="skipAutoOrderSetup">If true the setup of the auto order record is skipped.</param>
        ...
        /// </summary>
        /// <value>Names of pricing tiers to price this order against, without associating a customer profile.  An unknown tier name will fail the import.  An item that also supplies arbitrary_unit_cost keeps that cost and ignores the tier.  If a customer profile is attached to this order during checkout, these tiers are granted to that profile permanently.</value>
        ...
        /// </summary>
        /// <value>Date/time the original order was placed on the channel partner&#39;s system, in ISO8601 format. Only honored when store_completed is true (historical order imports). Rejected on live orders.</value>
        ...
        /// </summary>
        /// <value>If true the setup of the auto order record is skipped</value>
