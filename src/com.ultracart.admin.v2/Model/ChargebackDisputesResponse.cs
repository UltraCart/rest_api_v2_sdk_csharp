...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ChargebackDisputesResponse :  IEquatable<ChargebackDisputesResponse>, IValidatableObject
    {
        ...
        public ChargebackDisputesResponse(List<ChargebackDispute> Chargebacks = default(List<ChargebackDispute>), Error Error = default(Error), ResponseMetadata Metadata = default(ResponseMetadata), bool? Success = default(bool?))
        {
