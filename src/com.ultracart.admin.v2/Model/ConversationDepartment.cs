...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ConversationDepartment :  IEquatable<ConversationDepartment>, IValidatableObject
    {
        ...
        public ConversationDepartment(int conversationDepartmentOid = default(int), string departmentName = default(string), string merchantId = default(string), Object settings = default(Object))
        {
