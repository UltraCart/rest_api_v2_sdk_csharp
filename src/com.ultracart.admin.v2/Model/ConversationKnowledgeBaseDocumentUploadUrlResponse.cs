...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConversationKnowledgeBaseDocumentUploadUrlResponse :  IEquatable<ConversationKnowledgeBaseDocumentUploadUrlResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ConversationKnowledgeBaseDocumentUploadUrlResponse);
        }

        /// <summary>
        /// Returns true if ConversationKnowledgeBaseDocumentUploadUrlResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConversationKnowledgeBaseDocumentUploadUrlResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationKnowledgeBaseDocumentUploadUrlResponse input)
        {
            if (input == null)
                return false;
