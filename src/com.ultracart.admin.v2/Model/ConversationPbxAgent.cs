...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ConversationPbxAgent :  IEquatable<ConversationPbxAgent>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The default phone number that this agent should dial out to the PSTN with.</value>
        [DataMember(Name="default_phone_number_uuid", EmitDefaultValue=false)]
        public string DefaultPhoneNumberUuid { get; set; }
        ...
        public bool Equals(ConversationPbxAgent input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.DefaultPhoneNumberUuid != null &&
                    this.DefaultPhoneNumberUuid.Equals(input.DefaultPhoneNumberUuid))
                ) && 
                (
