...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ConversationWebchatQueueStatusAgent :  IEquatable<ConversationWebchatQueueStatusAgent>, IValidatableObject
    {
        ...
        /// <param name="agentUserId">Agent user id (populated by Java so the dispatch-scheduler Lambda can read it directly without parsing conversation_participant_arn).</param>
        ...
        /// <param name="customStatusName">Active custom status display name for this agent (denormalized).</param>
        /// <param name="customStatusUuid">Active custom status uuid for this agent (null when on a system status).</param>
        ...
        public ConversationWebchatQueueStatusAgent(AgentStatusEnum? agentStatus = default(AgentStatusEnum?), string agentUserId = default(string), string conversationParticipantArn = default(string), string conversationParticipantName = default(string), string customStatusName = default(string), string customStatusUuid = default(string), string lastChatDts = default(string), bool nextRoundRobin = default(bool), string profileImageUrl = default(string))
        {
        ...
        /// </summary>
        /// <value>Agent user id (populated by Java so the dispatch-scheduler Lambda can read it directly without parsing conversation_participant_arn)</value>
        ...
        /// </summary>
        /// <value>Active custom status display name for this agent (denormalized)</value>
        ...
        /// </summary>
        /// <value>Active custom status uuid for this agent (null when on a system status)</value>
