...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponAmountOffItems :  IEquatable<CouponAmountOffItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponAmountOffItems" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CouponAmountOffItems);
        }

        /// <summary>
        /// Returns true if CouponAmountOffItems instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponAmountOffItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponAmountOffItems input)
        {
            if (input == null)
                return false;
