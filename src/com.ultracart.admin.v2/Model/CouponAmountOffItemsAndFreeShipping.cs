...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponAmountOffItemsAndFreeShipping :  IEquatable<CouponAmountOffItemsAndFreeShipping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponAmountOffItemsAndFreeShipping" /> class.
        /// </summary>
        /// <param name="currencyCode">The ISO-4217 three letter currency code the customer is viewing prices in.</param>
        /// <param name="discountAmount">The amount of discount.</param>
        ...
        public CouponAmountOffItemsAndFreeShipping(string currencyCode = default(string), decimal discountAmount = default(decimal), List<string> itemTags = default(List<string>), List<string> items = default(List<string>), int limit = default(int), List<string> shippingMethods = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>The amount of discount</value>
        ...
        /// </summary>
        /// <value>A list of items which are eligible for the discount amount.</value>
        ...
        {
            return this.Equals(input as CouponAmountOffItemsAndFreeShipping);
        }

        /// <summary>
        /// Returns true if CouponAmountOffItemsAndFreeShipping instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponAmountOffItemsAndFreeShipping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponAmountOffItemsAndFreeShipping input)
        {
            if (input == null)
                return false;
