...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponAmountOffShipping :  IEquatable<CouponAmountOffShipping>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CouponAmountOffShipping);
        }

        /// <summary>
        /// Returns true if CouponAmountOffShipping instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponAmountOffShipping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponAmountOffShipping input)
        {
            if (input == null)
                return false;
