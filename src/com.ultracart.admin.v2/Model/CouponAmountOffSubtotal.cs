...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponAmountOffSubtotal :  IEquatable<CouponAmountOffSubtotal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponAmountOffSubtotal" /> class.
        /// </summary>
        ...
        public CouponAmountOffSubtotal(string currencyCode = default(string), decimal? discountAmount = default(decimal?))
        {
        ...
        {
            return this.Equals(input as CouponAmountOffSubtotal);
        }

        /// <summary>
        /// Returns true if CouponAmountOffSubtotal instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponAmountOffSubtotal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponAmountOffSubtotal input)
        {
            if (input == null)
                return false;
