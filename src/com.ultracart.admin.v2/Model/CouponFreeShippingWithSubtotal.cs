...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponFreeShippingWithSubtotal :  IEquatable<CouponFreeShippingWithSubtotal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponFreeShippingWithSubtotal" /> class.
        /// </summary>
        ...
        public CouponFreeShippingWithSubtotal(string CurrencyCode = default(string), decimal? PurchaseAmount = default(decimal?), List<string> ShippingMethods = default(List<string>))
        {
        ...
        {
            return this.Equals(input as CouponFreeShippingWithSubtotal);
        }

        /// <summary>
        /// Returns true if CouponFreeShippingWithSubtotal instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponFreeShippingWithSubtotal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponFreeShippingWithSubtotal input)
        {
            if (input == null)
                return false;
