...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponPercentOffItems :  IEquatable<CouponPercentOffItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponPercentOffItems" /> class.
        /// </summary>
        ...
        public CouponPercentOffItems(decimal? discountPercent = default(decimal?), List<string> excludedItemTags = default(List<string>), List<string> excludedItems = default(List<string>), List<string> itemTags = default(List<string>), List<string> items = default(List<string>), int? limit = default(int?))
        {
        ...
        {
            return this.Equals(input as CouponPercentOffItems);
        }

        /// <summary>
        /// Returns true if CouponPercentOffItems instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponPercentOffItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponPercentOffItems input)
        {
            if (input == null)
                return false;
