...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponPercentOffMsrpItems :  IEquatable<CouponPercentOffMsrpItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponPercentOffMsrpItems" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CouponPercentOffMsrpItems);
        }

        /// <summary>
        /// Returns true if CouponPercentOffMsrpItems instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponPercentOffMsrpItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponPercentOffMsrpItems input)
        {
            if (input == null)
                return false;
