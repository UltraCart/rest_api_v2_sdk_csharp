...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponPercentOffRetailPriceItems :  IEquatable<CouponPercentOffRetailPriceItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponPercentOffRetailPriceItems" /> class.
        /// </summary>
        ...
        public CouponPercentOffRetailPriceItems(decimal discountPercent = default(decimal), List<string> excludedItems = default(List<string>), List<string> items = default(List<string>), int limit = default(int))
        {
        ...
        {
            return this.Equals(input as CouponPercentOffRetailPriceItems);
        }

        /// <summary>
        /// Returns true if CouponPercentOffRetailPriceItems instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponPercentOffRetailPriceItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponPercentOffRetailPriceItems input)
        {
            if (input == null)
                return false;
