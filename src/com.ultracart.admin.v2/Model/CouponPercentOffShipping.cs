...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponPercentOffShipping :  IEquatable<CouponPercentOffShipping>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CouponPercentOffShipping);
        }

        /// <summary>
        /// Returns true if CouponPercentOffShipping instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponPercentOffShipping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponPercentOffShipping input)
        {
            if (input == null)
                return false;
