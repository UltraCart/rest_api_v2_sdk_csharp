...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponPercentOffSubtotalLimit :  IEquatable<CouponPercentOffSubtotalLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponPercentOffSubtotalLimit" /> class.
        /// </summary>
        ...
        /// <param name="Limit">The maximum amount of subtotal used to determine discount..</param>
        public CouponPercentOffSubtotalLimit(string CurrencyCode = default(string), decimal? DiscountPercent = default(decimal?), decimal? Limit = default(decimal?))
        {
        ...
        /// </summary>
        /// <value>The maximum amount of subtotal used to determine discount.</value>
        ...
        {
            return this.Equals(input as CouponPercentOffSubtotalLimit);
        }

        /// <summary>
        /// Returns true if CouponPercentOffSubtotalLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponPercentOffSubtotalLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponPercentOffSubtotalLimit input)
        {
            if (input == null)
                return false;
