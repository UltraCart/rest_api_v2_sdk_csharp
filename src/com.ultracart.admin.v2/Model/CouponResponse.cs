...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class CouponResponse :  IEquatable<CouponResponse>, IValidatableObject
    {
        ...
        public CouponResponse(Coupon Coupon = default(Coupon), Error Error = default(Error), ResponseMetadata Metadata = default(ResponseMetadata), bool? Success = default(bool?))
        {
            this.Coupon = Coupon;
            this.Error = Error;
