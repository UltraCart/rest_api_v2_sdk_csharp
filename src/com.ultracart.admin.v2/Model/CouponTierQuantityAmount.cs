...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponTierQuantityAmount :  IEquatable<CouponTierQuantityAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponTierQuantityAmount" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CouponTierQuantityAmount);
        }

        /// <summary>
        /// Returns true if CouponTierQuantityAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponTierQuantityAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponTierQuantityAmount input)
        {
            if (input == null)
                return false;
