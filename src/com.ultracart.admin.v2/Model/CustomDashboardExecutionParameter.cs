...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class CustomDashboardExecutionParameter :  IEquatable<CustomDashboardExecutionParameter>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets QuickPickKey
        /// </summary>
        [DataMember(Name="quick_pick_key", EmitDefaultValue=false)]
        public string QuickPickKey { get; set; }
        ...
        public bool Equals(CustomDashboardExecutionParameter input)
        {
            ...
            return 
                ...
                (
                    this.QuickPickKey == input.QuickPickKey ||
                    (this.QuickPickKey != null &&
                    this.QuickPickKey.Equals(input.QuickPickKey))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.QuickPickKey != null)
                    hashCode = hashCode * 59 + this.QuickPickKey.GetHashCode();
                if (this.Type != null)
