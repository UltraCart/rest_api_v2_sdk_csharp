...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerBilling :  IEquatable<CustomerBilling>, IValidatableObject
    {
        /// <summary>
        ...
        public CustomerBilling(string address1 = default(string), string address2 = default(string), string city = default(string), string company = default(string), string countryCode = default(string), int customerBillingOid = default(int), int customerProfileOid = default(int), string dayPhone = default(string), string dayPhoneE164 = default(string), bool defaultBilling = default(bool), string eveningPhone = default(string), string eveningPhoneE164 = default(string), string firstName = default(string), string lastName = default(string), string lastUsedDts = default(string), string postalCode = default(string), string stateRegion = default(string), string taxCounty = default(string), string title = default(string))
        {
        ...
        /// </summary>
        /// <value>Customer profile billing object identifier</value>
        [DataMember(Name="customer_billing_oid", EmitDefaultValue=false)]
        public int CustomerBillingOid { get; set; }
        ...
        /// Default billing
        /// </summary>
        /// <value>Default billing</value>
        [DataMember(Name="default_billing", EmitDefaultValue=false)]
