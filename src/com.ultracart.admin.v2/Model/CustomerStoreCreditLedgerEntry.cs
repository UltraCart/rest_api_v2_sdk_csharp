...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerStoreCreditLedgerEntry :  IEquatable<CustomerStoreCreditLedgerEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerStoreCreditLedgerEntry" /> class.
        /// </summary>
        /// <param name="action">Identifies the state of this ledger entry whether the entry is Vesting or Expiring.</param>
        ...
        public CustomerStoreCreditLedgerEntry(string action = default(string), decimal? amount = default(decimal?), string description = default(string), string entryDts = default(string), int? giftCertificateLedgerOid = default(int?), int? giftCertificateOid = default(int?), string referenceOrderId = default(string))
        {
            this.Action = action;
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>Identifies the state of this ledger entry whether the entry is Vesting or Expiring</value>
        ...
        {
            return this.Equals(input as CustomerStoreCreditLedgerEntry);
        }

        /// <summary>
        /// Returns true if CustomerStoreCreditLedgerEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomerStoreCreditLedgerEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomerStoreCreditLedgerEntry input)
        {
            if (input == null)
                return false;
