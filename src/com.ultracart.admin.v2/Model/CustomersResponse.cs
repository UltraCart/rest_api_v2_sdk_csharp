...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class CustomersResponse :  IEquatable<CustomersResponse>, IValidatableObject
    {
        ...
        public CustomersResponse(List<Customer> customers = default(List<Customer>), Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), bool success = default(bool), Warning warning = default(Warning))
        {
