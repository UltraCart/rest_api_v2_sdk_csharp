...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DistributionCentersResponse :  IEquatable<DistributionCentersResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public DistributionCentersResponse(List<DistributionCenter> distributionCenters = default(List<DistributionCenter>), Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), bool? success = default(bool?))
        {
        ...
        {
            return this.Equals(input as DistributionCentersResponse);
        }

        /// <summary>
        /// Returns true if DistributionCentersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionCentersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionCentersResponse input)
        {
            if (input == null)
                return false;
