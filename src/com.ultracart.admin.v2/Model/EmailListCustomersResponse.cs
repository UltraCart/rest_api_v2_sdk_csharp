...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailListCustomersResponse :  IEquatable<EmailListCustomersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailListCustomersResponse" /> class.
        /// </summary>
        ...
        public EmailListCustomersResponse(List<EmailListCustomer> Customers = default(List<EmailListCustomer>), int? PageNumber = default(int?), int? PageSize = default(int?), int? TotalCustomers = default(int?), int? TotalPages = default(int?))
        {
        ...
        public List<EmailListCustomer> Customers { get; set; }
        ...
        {
            return this.Equals(input as EmailListCustomersResponse);
        }

        /// <summary>
        /// Returns true if EmailListCustomersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailListCustomersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailListCustomersResponse input)
        {
            if (input == null)
                return false;
