...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailSegmentCustomersResponse :  IEquatable<EmailSegmentCustomersResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public List<EmailSegmentCustomer> Customers { get; set; }
        ...
        {
            return this.Equals(input as EmailSegmentCustomersResponse);
        }

        /// <summary>
        /// Returns true if EmailSegmentCustomersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailSegmentCustomersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailSegmentCustomersResponse input)
        {
            if (input == null)
                return false;
