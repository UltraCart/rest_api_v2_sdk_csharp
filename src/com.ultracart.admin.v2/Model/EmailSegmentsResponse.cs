...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailSegmentsResponse :  IEquatable<EmailSegmentsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EmailSegmentsResponse);
        }

        /// <summary>
        /// Returns true if EmailSegmentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailSegmentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailSegmentsResponse input)
        {
            if (input == null)
                return false;
