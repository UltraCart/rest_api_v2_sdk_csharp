...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailSettingsResponse :  IEquatable<EmailSettingsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailSettingsResponse" /> class.
        /// </summary>
        ...
        public EmailSettingsResponse(Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), EmailSettings settings = default(EmailSettings), bool success = default(bool), Warning warning = default(Warning))
        {
            this.Error = error;
