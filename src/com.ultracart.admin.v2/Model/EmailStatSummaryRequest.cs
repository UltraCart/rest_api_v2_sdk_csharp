...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailStatSummaryRequest :  IEquatable<EmailStatSummaryRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets CommseqEmailUuids
        /// </summary>
        ...
        {
            return this.Equals(input as EmailStatSummaryRequest);
        }

        /// <summary>
        /// Returns true if EmailStatSummaryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailStatSummaryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailStatSummaryRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CommseqEmailUuids == input.CommseqEmailUuids ||
                    this.CommseqEmailUuids != null &&
                    input.CommseqEmailUuids != null &&
