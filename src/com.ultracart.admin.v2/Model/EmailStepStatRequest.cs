...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailStepStatRequest :  IEquatable<EmailStepStatRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailStepStatRequest" /> class.
        /// </summary>
        /// <param name="commseqStepUuids">commseqStepUuids.</param>
        /// <param name="days">days.</param>
        public EmailStepStatRequest(List<string> commseqStepUuids = default(List<string>), int days = default(int))
        {
        ...
        {
            return this.Equals(input as EmailStepStatRequest);
        }

        /// <summary>
        /// Returns true if EmailStepStatRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailStepStatRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailStepStatRequest input)
        {
            if (input == null)
                return false;
