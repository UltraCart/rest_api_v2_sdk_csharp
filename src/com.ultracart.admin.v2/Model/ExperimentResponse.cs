...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ExperimentResponse :  IEquatable<ExperimentResponse>, IValidatableObject
    {
        ...
        public ExperimentResponse(Error error = default(Error), Experiment experiment = default(Experiment), ResponseMetadata metadata = default(ResponseMetadata), bool? success = default(bool?), Warning warning = default(Warning))
        {
            this.Error = error;
