...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class GroupResponse :  IEquatable<GroupResponse>, IValidatableObject
    {
        ...
        public GroupResponse(Error error = default(Error), Group group = default(Group), ResponseMetadata metadata = default(ResponseMetadata), bool success = default(bool), Warning warning = default(Warning))
        {
            this.Error = error;
            this.Group = group;
