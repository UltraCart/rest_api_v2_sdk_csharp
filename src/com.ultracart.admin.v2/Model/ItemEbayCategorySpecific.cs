...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemEbayCategorySpecific :  IEquatable<ItemEbayCategorySpecific>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ItemEbayCategorySpecific);
        }

        /// <summary>
        /// Returns true if ItemEbayCategorySpecific instances are equal
        /// </summary>
        /// <param name="other">Instance of ItemEbayCategorySpecific to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemEbayCategorySpecific other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
