...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ItemKitDefinition :  IEquatable<ItemKitDefinition>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ItemKitDefinition);
        }

        /// <summary>
        /// Returns true if ItemKitDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemKitDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemKitDefinition input)
        {
            if (input == null)
                return false;
