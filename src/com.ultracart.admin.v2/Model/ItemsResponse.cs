...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ItemsResponse :  IEquatable<ItemsResponse>, IValidatableObject
    {
        ...
        public ItemsResponse(Error error = default(Error), List<Item> items = default(List<Item>), ResponseMetadata metadata = default(ResponseMetadata), bool success = default(bool), Warning warning = default(Warning))
        {
            this.Error = error;
            this.Items = items;
