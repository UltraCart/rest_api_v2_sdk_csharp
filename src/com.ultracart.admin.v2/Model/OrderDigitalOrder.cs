...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderDigitalOrder :  IEquatable<OrderDigitalOrder>
    {
        /// <summary>
        ...
        public OrderDigitalOrder(string CreationDts = null, string ExpirationDts = null, List<OrderDigitalItem> Items = null, string Url = null, string UrlId = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrderDigitalOrder);
        }

        /// <summary>
        /// Returns true if OrderDigitalOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderDigitalOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderDigitalOrder other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UrlId != null)
                    hash = hash * 59 + this.UrlId.GetHashCode();
                return hash;
            }
        }
    }
