...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderItemProperty :  IEquatable<OrderItemProperty>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OrderItemProperty);
        }

        /// <summary>
        /// Returns true if OrderItemProperty instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderItemProperty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderItemProperty input)
        {
            if (input == null)
                return false;
