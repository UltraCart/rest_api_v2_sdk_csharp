...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderItemTag :  IEquatable<OrderItemTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderItemTag" /> class.
        /// </summary>
        /// <param name="tagValue">Tag Value.</param>
        public OrderItemTag(string tagValue = default(string))
        {
        ...
        {
            return this.Equals(input as OrderItemTag);
        }

        /// <summary>
        /// Returns true if OrderItemTag instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderItemTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderItemTag input)
        {
            if (input == null)
                return false;
