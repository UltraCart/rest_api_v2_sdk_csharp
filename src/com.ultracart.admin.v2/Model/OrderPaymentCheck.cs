...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderPaymentCheck :  IEquatable<OrderPaymentCheck>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OrderPaymentCheck);
        }

        /// <summary>
        /// Returns true if OrderPaymentCheck instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderPaymentCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderPaymentCheck input)
        {
            if (input == null)
                return false;
