...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderPaymentCheck :  IEquatable<OrderPaymentCheck>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderPaymentCheck" /> class.
        /// </summary>
        /// <param name="CheckNumber">Check number.</param>
        public OrderPaymentCheck(string CheckNumber = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrderPaymentCheck);
        }

        /// <summary>
        /// Returns true if OrderPaymentCheck instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderPaymentCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderPaymentCheck other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
