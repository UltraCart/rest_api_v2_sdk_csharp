...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class ReportsResponse :  IEquatable<ReportsResponse>, IValidatableObject
    {
        ...
        public ReportsResponse(Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), List<Report> reports = default(List<Report>), bool? success = default(bool?), Warning warning = default(Warning))
        {
            this.Error = error;
