...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScreenRecordingFilterIpSearch :  IEquatable<ScreenRecordingFilterIpSearch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenRecordingFilterIpSearch" /> class.
        /// </summary>
        /// <param name="doesNotExist">doesNotExist.</param>
        /// <param name="exists">exists.</param>
        /// <param name="_is">_is.</param>
        /// <param name="isNot">isNot.</param>
        public ScreenRecordingFilterIpSearch(bool doesNotExist = default(bool), bool exists = default(bool), string _is = default(string), string isNot = default(string))
        {
        ...
        {
            return this.Equals(input as ScreenRecordingFilterIpSearch);
        }

        /// <summary>
        /// Returns true if ScreenRecordingFilterIpSearch instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenRecordingFilterIpSearch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenRecordingFilterIpSearch input)
        {
            if (input == null)
                return false;
