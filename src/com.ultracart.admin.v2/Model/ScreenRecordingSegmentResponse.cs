...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScreenRecordingSegmentResponse :  IEquatable<ScreenRecordingSegmentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ScreenRecordingSegment Segment { get; set; }
        ...
        {
            return this.Equals(input as ScreenRecordingSegmentResponse);
        }

        /// <summary>
        /// Returns true if ScreenRecordingSegmentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenRecordingSegmentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenRecordingSegmentResponse input)
        {
            if (input == null)
                return false;
