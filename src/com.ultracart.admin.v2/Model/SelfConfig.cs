...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SelfConfig :  IEquatable<SelfConfig>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SelfConfig);
        }

        /// <summary>
        /// Returns true if SelfConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of SelfConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelfConfig input)
        {
            if (input == null)
                return false;
