...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class TaxCountry :  IEquatable<TaxCountry>, IValidatableObject
    {
        ...
        /// <param name="vatThreshold">VAT collection threshold for this country. Blank means no threshold, 0 always collects VAT, a positive value collects at or below that order subtotal..</param>
        /// <param name="vatThresholdCurrency">Currency code the vat_threshold amount is expressed in (USD, EUR or GBP)..</param>
        public TaxCountry(string accountingCode = default(string), string countryCode = default(string), int countryOid = default(int), List<TaxState> states = default(List<TaxState>), bool taxGiftCharge = default(bool), bool taxGiftWrap = default(bool), decimal taxRate = default(decimal), string taxRateFormatted = default(string), bool taxShipping = default(bool), decimal vatThreshold = default(decimal), string vatThresholdCurrency = default(string))
        {
        ...
        /// </summary>
        /// <value>VAT collection threshold for this country. Blank means no threshold, 0 always collects VAT, a positive value collects at or below that order subtotal.</value>
