...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxProviderUltraCart :  IEquatable<TaxProviderUltraCart>, IValidatableObject
    {
        /// <summary>
        ...
        public UltraCartConfig _Configuration { get; set; }
        ...
        /// </summary>
        /// <value>States in the union showing their management status</value>
        [DataMember(Name="states", EmitDefaultValue=false)]
        public List<TaxProviderUltraCartState> States { get; set; }
        ...
        {
            return this.Equals(input as TaxProviderUltraCart);
        }

        /// <summary>
        /// Returns true if TaxProviderUltraCart instances are equal
        /// </summary>
        /// <param name="input">Instance of TaxProviderUltraCart to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxProviderUltraCart input)
        {
            if (input == null)
                return false;
