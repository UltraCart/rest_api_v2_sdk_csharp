...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class TaxState :  IEquatable<TaxState>, IValidatableObject
    {
        ...
        /// <param name="vatThreshold">VAT collection threshold override for this region. Blank inherits the country threshold, 0 always collects VAT, a positive value collects at or below that order subtotal..</param>
        /// <param name="vatThresholdCurrency">Currency code the vat_threshold amount is expressed in (USD, EUR or GBP)..</param>
        public TaxState(string accountingCode = default(string), List<TaxCounty> counties = default(List<TaxCounty>), int countryOid = default(int), bool dontCollectCity = default(bool), bool dontCollectCounty = default(bool), bool dontCollectPostalCode = default(bool), bool dontCollectState = default(bool), bool exemptDigitalItems = default(bool), bool exemptPhysicalItems = default(bool), bool exemptServiceItems = default(bool), string stateCode = default(string), int stateOid = default(int), bool taxGiftCharge = default(bool), bool taxGiftWrap = default(bool), decimal taxRate = default(decimal), string taxRateFormatted = default(string), bool taxShipping = default(bool), bool useUltracartManagedRates = default(bool), decimal vatThreshold = default(decimal), string vatThresholdCurrency = default(string))
        {
        ...
        /// </summary>
        /// <value>VAT collection threshold override for this region. Blank inherits the country threshold, 0 always collects VAT, a positive value collects at or below that order subtotal.</value>
        [DataMember(Name="vat_threshold", EmitDefaultValue=false)]
        public decimal VatThreshold { get; set; }

        /// <summary>
        /// Currency code the vat_threshold amount is expressed in (USD, EUR or GBP).
        /// </summary>
        /// <value>Currency code the vat_threshold amount is expressed in (USD, EUR or GBP).</value>
        [DataMember(Name="vat_threshold_currency", EmitDefaultValue=false)]
        public string VatThresholdCurrency { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VatThreshold: ").Append(VatThreshold).Append("\n");
            sb.Append("  VatThresholdCurrency: ").Append(VatThresholdCurrency).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(TaxState input)
        {
            ...
            return 
                ...
                (
                    this.VatThreshold == input.VatThreshold ||
                    (this.VatThreshold != null &&
                    this.VatThreshold.Equals(input.VatThreshold))
                ) && 
                (
                    this.VatThresholdCurrency == input.VatThresholdCurrency ||
                    (this.VatThresholdCurrency != null &&
                    this.VatThresholdCurrency.Equals(input.VatThresholdCurrency))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VatThreshold != null)
                    hashCode = hashCode * 59 + this.VatThreshold.GetHashCode();
                if (this.VatThresholdCurrency != null)
                    hashCode = hashCode * 59 + this.VatThresholdCurrency.GetHashCode();
                return hashCode;
            }
        }
