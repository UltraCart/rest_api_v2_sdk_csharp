...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class TempMultimediaResponse :  IEquatable<TempMultimediaResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TempMultimediaResponse);
        }

        /// <summary>
        /// Returns true if TempMultimediaResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TempMultimediaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TempMultimediaResponse input)
        {
            if (input == null)
                return false;
