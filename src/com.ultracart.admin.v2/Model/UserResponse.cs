...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class UserResponse :  IEquatable<UserResponse>, IValidatableObject
    {
        ...
        public UserResponse(Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), bool? success = default(bool?), User user = default(User), Warning warning = default(Warning))
        {
            this.Error = error;
