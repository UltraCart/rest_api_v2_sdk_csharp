...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class UsersResponse :  IEquatable<UsersResponse>, IValidatableObject
    {
        ...
        public UsersResponse(Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), bool? success = default(bool?), List<User> users = default(List<User>), Warning warning = default(Warning))
        {
            this.Error = error;
