...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class WebhookEventSubscription :  IEquatable<WebhookEventSubscription>, IValidatableObject
    {
        ...
        /// <param name="eventRuler">Optional - Event ruler expression to filter events to.  Only events that match this Ruler expression will be transmitted to the webhook..</param>
        ...
        public WebhookEventSubscription(string comments = default(string), bool? deprecatedFlag = default(bool?), bool? discontinuedFlag = default(bool?), string eventDescription = default(string), string eventName = default(string), string eventRuler = default(string), string expansion = default(string), bool? subscribed = default(bool?), bool? supportsReflow = default(bool?), int? webhookEventOid = default(int?))
        {
        ...
        /// </summary>
        /// <value>Optional - Event ruler expression to filter events to.  Only events that match this Ruler expression will be transmitted to the webhook.</value>
        [DataMember(Name="event_ruler", EmitDefaultValue=false)]
        public string EventRuler { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EventRuler: ").Append(EventRuler).Append("\n");
        ...
        public bool Equals(WebhookEventSubscription input)
        {
            ...
            return 
                ...
                (
                    this.EventRuler == input.EventRuler ||
                    (this.EventRuler != null &&
                    this.EventRuler.Equals(input.EventRuler))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EventRuler != null)
                    hashCode = hashCode * 59 + this.EventRuler.GetHashCode();
