...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class WebhookSampleRequestResponse :  IEquatable<WebhookSampleRequestResponse>, IValidatableObject
    {
        ...
        public WebhookSampleRequestResponse(Error Error = default(Error), ResponseMetadata Metadata = default(ResponseMetadata), bool? Success = default(bool?), WebhookSampleRequest WebhookSampleRequest = default(WebhookSampleRequest))
        {
            this.Error = Error;
