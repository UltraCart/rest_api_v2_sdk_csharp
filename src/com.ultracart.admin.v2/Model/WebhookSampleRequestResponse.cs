...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookSampleRequestResponse :  IEquatable<WebhookSampleRequestResponse>
    {
        /// <summary>
        ...
        public WebhookSampleRequestResponse(Error Error = null, ResponseMetadata Metadata = null, bool? Success = null, WebhookSampleRequest WebhookSampleRequest = null)
        {
            this.Error = Error;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WebhookSampleRequestResponse);
        }

        /// <summary>
        /// Returns true if WebhookSampleRequestResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of WebhookSampleRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookSampleRequestResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.WebhookSampleRequest == other.WebhookSampleRequest ||
                    this.WebhookSampleRequest != null &&
                    this.WebhookSampleRequest.Equals(other.WebhookSampleRequest)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WebhookSampleRequest != null)
                    hash = hash * 59 + this.WebhookSampleRequest.GetHashCode();
                return hash;
            }
        }
    }
