...
namespace com.ultracart.admin.v2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkflowTasksResponse :  IEquatable<WorkflowTasksResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTasksResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as WorkflowTasksResponse);
        }

        /// <summary>
        /// Returns true if WorkflowTasksResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowTasksResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowTasksResponse input)
        {
            if (input == null)
                return false;
