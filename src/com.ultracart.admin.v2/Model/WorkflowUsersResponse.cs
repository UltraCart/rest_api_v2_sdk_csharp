...
namespace com.ultracart.admin.v2.Model
{
    ...
    public partial class WorkflowUsersResponse :  IEquatable<WorkflowUsersResponse>, IValidatableObject
    {
        ...
        public WorkflowUsersResponse(Error error = default(Error), ResponseMetadata metadata = default(ResponseMetadata), bool? success = default(bool?), List<WorkflowUser> users = default(List<WorkflowUser>), Warning warning = default(Warning))
        {
            this.Error = error;
